            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">This Page Belongs To Developer</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    {{-- <h5 class="card-title text-center pb-0 fs-4">This Page Belongs To Developer</h5> --}}
                    {{-- <p class="text-center small">if you are not a developer, please do not access this page</p> --}}
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12 text-center mt-4">
                      <p class="small mb-0 text-secondary">If you are not a developer, please do not access this page</p>
                    </div>
                  </form>
